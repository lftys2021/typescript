...
var result4 = print2("홍길동");
// 여기서:
// <string>
// 이라고 지정했기 때문에 T는 string이 됩니다.
// 숫자는:
var result5 = print2(100);
// 입니다.
console.log(result4);
console.log(result5);
/*----------------------------------------------------------------------------------------------------*/
...
// 예를 들어:
var result6 = print3("홍길동");
var result7 = print4("홍길동");
...
function getFirst1(items) {
    return items[0];
}
// 사용:
var student1 = getFirst1(students);
...
// 학생 배열을 넣으면:
var student2 = findItem(students, 0);
// T는 Student가 됩니다.
// 따라서:
// student
// 는:
