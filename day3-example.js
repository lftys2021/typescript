...
// 예시
// 95
var total = students.reduce(function (max, student) {
...
// 과제 4. 평균 점수
// 평균을 계산하세요.
var total1 = students.reduce(function (sum, student) { return sum + student.score; }, 0);
var average = total1 / students.length;
console.log(average);
/*-------------------------4---------------------------------------------------------------------------*/
